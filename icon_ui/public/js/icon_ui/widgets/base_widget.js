...
export default class Widget {
	...
	set_icon(){
		let color = this.custom_icon_color? this.custom_icon_color : "#761ACB";
		
		if(this.custom_app_icon && this.custom_app_icon != null && this.custom_app_icon != ''){
			$(`	<div class="widget-icon" style="background-color: ${color};">
					<svg>
						<use href="#icon-${this.custom_app_icon}"></use>
					</svg>
				</div>`).prependTo(this.widget);
		
		this.icon_widget = this.widget.find(".widget-icon");
		}
	}
